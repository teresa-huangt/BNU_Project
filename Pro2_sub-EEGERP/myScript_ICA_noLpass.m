...
% parentfolder = 'D:/Work_D/EXP3-TAIL-vowel/data_deletebadchannel/';
    ...
    appendix =  '_Chan_elist_hpfilt_ref_bins_epochs_rej';
%     
%     % 1
...
%      
     % 2
     sname = [subjectfolder 'refM_noLpass' subject  appendix '.set'];
     sub_sname = ['refM_noLpass'  subject  appendix '.set'];
...
%         subjectPreproICA = ['refM_firstS_' subject  appendix '_ica' ];
        ...
        % 2
        subjectPreproICA = ['refM_noLpass' subject  appendix '_ica' ];
