function OV = cal_phonemeLevel_CVT_medianRT(cond, lowCut, highCut)
...
%         RT(RT>cutoff) = NaN;
        ...
        OV.RTst(i, 1:4) = [nanmedian(RT(Tr==1 & Cr == 1 & Vr == 1)), ...
            nanmedian(RT(Tr==1 &Vr == 2 & Cr == 1)),nanmedian(RT(Tr==1 &Vr == 1 & Cr == 2)), ...
            nanmedian(RT(Tr==1 &Cr == 2 & Vr == 2))];
        OV.RTdt(i, 1:4) = [nanmedian(RT(Tr==2 & Cr == 1 & Vr == 1)), ...
            nanmedian(RT(Tr==2 &Vr == 2 & Cr == 1)),nanmedian(RT(Tr==2 &Vr == 1 & Cr == 2)), ...
            nanmedian(RT(Tr==2 &Cr == 2 & Vr == 2))];
