function plot_congruency_LISAS(taskN,index) 
% 
...
switch index    
        case 'CV-SD' %mean
        structureDir = data2.(taskName).congruency_mean.CVLISAS(:,[1 2]);
        titleName = ['TAIL-'  taskName '-CV-SD'];   
        labelXtick = {'CV-S', 'CV-D'};
        case 'CV-CONG' 
        structureDir = data2.(taskName).congruency_mean.CVLISAS(:,[3 4]);
        titleName = ['TAIL-'  taskName '-CV-congruency'];
        labelXtick = {'CV-CONGRUENT', 'CV-INCONGRUENT'};
        case 'ST-SD' 
        structureDir = data2.(taskName).congruency_mean.STLISAS(:,[1 2]);
        titleName = ['TAIL-'  taskName '-ST-SD'];
        labelXtick = {'ST-S', 'ST-D'};
        case 'ST-CONG' 
        structureDir = data2.(taskName).congruency_mean.STLISAS(:,[3 4]);
        titleName = ['TAIL-'  taskName '-ST-congruency'];
        labelXtick = {'ST-CONGRUENT', 'ST-INCONGRUENT'};
        case 'LW-SD' 
        structureDir = data2.(taskName).congruency_mean.LWLISAS(:,[1 2]);
        titleName = ['TAIL-'  taskName '-LW-SD'];
        labelXtick = {'LW-S', 'LW-D'};
        case 'LW-CONG' 
        structureDir = data2.(taskName).congruency_mean.LWLISAS(:,[3 4]);
        titleName = ['TAIL-'  taskName '-LW-congruency'];
        labelXtick = {'LW-CONGRUENT', 'LW-INCONGRUENT'};
         case 'SW-CONG-wordTask' 
        structureDir = data2.(taskName).SW.LISAS(:,[1 2]);
        titleName = ['TAIL-'  taskName '-SW-congruency'];
        labelXtick = {'SW-INCONGRUENT', 'SW-CONGRUENT'};
end
