function plot_congruency_IES(taskN,index) 
% 
...
switch index    
        case 'CV-SD' %mean
        structureDir = data2.(taskName).congruency_mean.CVIES(:,[1 2]);
        titleName = ['TAIL-'  taskName '-CV-SD'];   
        labelXtick = {'CV-S', 'CV-D'};
        case 'CV-CONG' 
        structureDir = data2.(taskName).congruency_mean.CVIES(:,[3 4]);
        titleName = ['TAIL-'  taskName '-CV-congruency'];
        labelXtick = {'CV-CONGRUENT', 'CV-INCONGRUENT'};
        case 'ST-SD' 
        structureDir = data2.(taskName).congruency_mean.STIES(:,[1 2]);
        titleName = ['TAIL-'  taskName '-ST-SD'];
        labelXtick = {'ST-S', 'ST-D'};
        case 'ST-CONG' 
        structureDir = data2.(taskName).congruency_mean.STIES(:,[3 4]);
        titleName = ['TAIL-'  taskName '-ST-congruency'];
        labelXtick = {'ST-CONGRUENT', 'ST-INCONGRUENT'};
        case 'LW-SD' 
        structureDir = data2.(taskName).congruency_mean.LWIES(:,[1 2]);
        titleName = ['TAIL-'  taskName '-LW-SD'];
        labelXtick = {'LW-S', 'LW-D'};
        case 'LW-CONG' 
        structureDir = data2.(taskName).congruency_mean.LWIES(:,[3 4]);
