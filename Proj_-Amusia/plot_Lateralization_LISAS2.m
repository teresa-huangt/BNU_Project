...
for i = 1:length(taskList)
 ...
 %data2.speechEar_rovGap.lateralization.LISAS(:,[5 6])
 structureBoth(:,[2*i-1, 2*i]) = data2.(taskName).lateralization.LISAS(:,[5 6]);
 targetL(:,i) = data2.(taskName).lateralization.LISAS(:,5);
 targetR(:,i) = data2.(taskName).lateralization.LISAS(:,6);
